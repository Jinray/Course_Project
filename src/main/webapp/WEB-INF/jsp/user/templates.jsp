...
<div ng-app="myApp" ng-controller="postController" class="col-md-10" style="margin: 0 8% 0 8%">
    ...
    <div class=" col-md-7 ">
        <div class="panel panel-primary" style="border: 1px solid #bbb">
            ...
            <%--&lt;%&ndash;<img ng-src="http://mbenford.github.io/ngTagsInput/images/flags/{{data.flag}}" />&ndash;%&gt;--%>
            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
        ...
        <div class="panel panel-primary" style="width: 100%;  border: 1px solid #bbb;  height: 100%;">
            ...
            <div style="height: 300px;  overflow: auto; margin-bottom: 10px; padding: 0 1% 0 1%">
                <div ng-click="setPost($index); title = post.title" class="unSelected"
                    ...
                    <a href="javascript:void(0)" ng-click="setPost($index); deletePost();" style="text-decoration: none;"><span class="icon-remove" style="font-size: 2em; float: right;"></span></a>
                </div>
            </div>
            ...
            <%--</div>--%>
            <%--<a href="javascript:void(0);" style="width: 49.5%;" class="btn btn-primary" type="submit" ng-disable="editingArticle.$.$invalid"--%>
            <%--ng-click="savePost();"></a>--%>
