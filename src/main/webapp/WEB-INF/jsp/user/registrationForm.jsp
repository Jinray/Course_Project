...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/app/user.form.js"></script>
        ...
        <div class="page-header" style="text-align: center;">
            <h2><spring:message code="label.user.registration.page.title"/></h2>
        </div>
            ...
            <div class="panel panel-default" style="width: 40%; margin: 0 30% 0 30%">
                <div class="panel-body">
                    <form:form action="${pageContext.request.contextPath}/user/register" commandName="user" method="POST" enctype="utf8" role="form">
                        ...
                        <div class="row">
                            <div id="form-group-firstName" class="form-group col-lg-12">
                        ...
                        <div class="row">
                            <div id="form-group-lastName" class="form-group col-lg-12">
                        ...
                        <c:if test="${user.signInProvider == null}">
                            ...
                            <div class="row">
                                <div id="form-group-passwordVerification" class="form-group col-lg-12">
                        ...
                        <button type="submit" class="btn btn-primary"><spring:message code="label.user.registration.submit.button"/></button>
                    </form:form>
                </div>
            </div>
        </sec:authorize>
