...
import com.KafanovAndRomanovich.TestUtil;
import com.KafanovAndRomanovich.WebTestConstants;
import com.KafanovAndRomanovich.config.UnitTestContext;
import com.KafanovAndRomanovich.config.WebAppContext;
import com.KafanovAndRomanovich.security.util.SecurityContextAssert;
import com.KafanovAndRomanovich.user.dto.RegistrationForm;
import com.KafanovAndRomanovich.user.dto.RegistrationFormAssert;
import com.KafanovAndRomanovich.user.model.SocialMediaService;
import com.KafanovAndRomanovich.user.model.User;
import com.KafanovAndRomanovich.user.model.UserBuilder;
...
public class RegistrationControllerTest {
    ...
    public void registerUserAccount_SocialSignInAndEmptyForm_ShouldRenderRegistrationFormWithValidationErrors() throws Exception {
        ...
        SecurityContextAssert.assertThat(SecurityContextHolder.getContext()).userIsAnonymous();
        TestProviderSignInAttemptAssert.assertThatSignIn(socialSignIn).createdNoConnections();
        verifyZeroInteractions(userServiceMock);
    }
    ...
    public void registerUserAccount_SocialSignIn_ShouldCreateNewUserAccountAndRenderHomePage() throws Exception {
        ...
        TestProviderSignInAttemptAssert.assertThatSignIn(socialSignIn).createdConnectionForUserId(EMAIL);
