...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/app/tagCloudModule.js"></script>
...
<div class="page">
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
            ...
            <span class="navbar-brand"><a href="${pageContext.request.contextPath}/login"><img width="80px"
                                                                                               src="${pageContext.request.contextPath}/static/images/logo.gif"></a></span>
        </div>
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-left">
                <sec:authorize access="isAuthenticated()">
                    <li><a href="${pageContext.request.contextPath}/"><img width="30px"
                                                                           src="${pageContext.request.contextPath}/static/images/list.png"><spring:message
                            code="label.navigation.home.link"/></a></li>
                </sec:authorize>
            </ul>
            <ul style="float: right; position:relative;top:10px">
                <a href="?lang=en"><img width="30px" src="${pageContext.request.contextPath}/static/images/US.png"> </a>
                <a href="?lang=ru"><img width="30px" src="${pageContext.request.contextPath}/static/images/ru.png"></a>
            </ul>
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Theme<span
                            class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#" onclick="setLightStyle()">Light</a></li>
                        <li><a href="#" onclick="setDarkStyle()">Dark</a></li>
                        <script>
                            (function startStyle() {
                                if (localStorage.getItem("style") === null)
                                    localStorage.setItem("style", "${pageContext.request.contextPath}/static/css/bootstrap.css");
                            ...
                            function setDarkStyle() {
                                localStorage.setItem("style", "${pageContext.request.contextPath}/static/css/darkly.min.css");
                                document.getElementById("style").href = localStorage.getItem("style");
                            }
                            ;
                        </script>
    ...
    <%--<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/switchThemes.js"></script>--%>
</body>
</html>